...
interface MaterialRepository {
    suspend fun load(page: Page, revision: DatabaseRevision): Result<MaterialModel>
}
...
class RemoteMaterialRepository(
    ...
    override suspend fun load(page: Page, revision: DatabaseRevision): Result<MaterialModel> = runCatching {
